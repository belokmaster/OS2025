...
// Программа создает три дочерних процесса и отправляет каждому из них сигнал SIGUSR1. 
// После этого она ожидает их завершения и сохраняет состояние процессов до и после отправки сигналов в файлы before.txt и after.txt.
